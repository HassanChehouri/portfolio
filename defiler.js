   ...
   // section montage video
    if(index ==0){
     ...
     //section design   
        ...
        document.getElementById("desc2").innerText = "Le projet Eventbrite est un projet dont j'ai du refaire une maquette d'un site web qui n'étais pas mis à jour depuis plusieurs mois. Ce projet à été entièrement réalisé sur Photshop.";
